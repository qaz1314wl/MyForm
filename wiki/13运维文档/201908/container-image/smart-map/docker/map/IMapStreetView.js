var LeadorStreetView = function(divContent, vars) {
    ...
    var basePath = LD["MapConfig"]["_MAP_PANORAMA"]["FLASH_DEPENDENTS_URL"];
        ...
        getScreenXY: function(stationID, lon, lat, fun){
        	 if (sv.swf) { 
        	     ...
        	     sv.getScreenXY["callback" + sv.getScreenXY.backNum]  = fun;
        	 	 sv.swf.getScreenXY(stationID, lon, lat, "LeadorStreetView.examples"+ LeadorStreetView.count + ".getScreenXY.callback"+sv.getScreenXY.backNum);
    ...
    cases = "LeadorStreetView.examples" + LeadorStreetView.count + ".listenerPool";
        sv.swfobject.embedSWF(sv.swfURL, sv.content, sv.width, sv.height, sv.swfVersionStr, sv.xiSwfUrlStr, sv.flashvars, sv.params, sv.attributes, loadSwfEnd);
    }
